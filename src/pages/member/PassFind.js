...
const PassFind = () => {
    ...
    return (
        <div className='inner'>
            ...
            { idInfo ? <div>비밀번호를 변경할 수 있습니다.<Link to="/updatepass"><button>비밀번호 변경하기</button></Link></div> : <><p className='small'>가입시 입력한 이름과 아이디(이메일)를 입력해 주세요</p>
